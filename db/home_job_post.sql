...
CREATE TABLE `job_post` (
  ...
  KEY `fk_candidate_rel_idx` (`company_id`),
  CONSTRAINT `fk_candidate_rel` FOREIGN KEY (`company_id`) REFERENCES `company` (`company_id`)
...
INSERT INTO `job_post` VALUES (2,1,'Draft','Luis','Luis','10:27:18.000000','10:27:18.000000',0);
...
-- Dump completed on 2024-12-22 21:57:14
